...
const
	catBHD = fs.readFileSync(__dirname + "/CAT.bhd"),

	// Have to write these out explicitly so that brfs's static transformation can catch them for us
	BHTs = [
		fs.readFileSync(__dirname + "/CAT0.bdt"),
		fs.readFileSync(__dirname + "/CAT1.bdt"),
		fs.readFileSync(__dirname + "/CAT2.bdt"),
		fs.readFileSync(__dirname + "/CAT3.bdt"),
	],

	decoder = new AnimationDecoder(catBHD);
