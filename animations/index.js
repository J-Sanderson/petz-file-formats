...
const
	bunnyBHD = fs.readFileSync(__dirname + "/BN.bhd"),

	// Have to write these out explicitly so that brfs's static transformation can catch them for us
	BHTs = [
		fs.readFileSync(__dirname + "/BN0.bdt"),
		fs.readFileSync(__dirname + "/BN1.bdt"),
		fs.readFileSync(__dirname + "/BN2.bdt"),
		fs.readFileSync(__dirname + "/BN3.bdt"),
		fs.readFileSync(__dirname + "/BN4.bdt"),
		fs.readFileSync(__dirname + "/BN5.bdt"),
		fs.readFileSync(__dirname + "/BN6.bdt"),
		fs.readFileSync(__dirname + "/BN7.bdt"),
		fs.readFileSync(__dirname + "/BN8.bdt"),
		fs.readFileSync(__dirname + "/BN9.bdt"),
		fs.readFileSync(__dirname + "/BN10.bdt"),
		fs.readFileSync(__dirname + "/BN11.bdt"),
		fs.readFileSync(__dirname + "/BN12.bdt"),
		fs.readFileSync(__dirname + "/BN13.bdt"),
		fs.readFileSync(__dirname + "/BN14.bdt"),
		fs.readFileSync(__dirname + "/BN15.bdt"),
		fs.readFileSync(__dirname + "/BN16.bdt"),
		fs.readFileSync(__dirname + "/BN17.bdt"),
		fs.readFileSync(__dirname + "/BN18.bdt"),
		fs.readFileSync(__dirname + "/BN19.bdt"),
		fs.readFileSync(__dirname + "/BN20.bdt"),
		fs.readFileSync(__dirname + "/BN21.bdt"),
	],
