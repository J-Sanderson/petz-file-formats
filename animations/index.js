...
const
	mouseBHD = fs.readFileSync(__dirname + "/MOUSE.bhd"),

	// Have to write these out explicitly so that brfs's static transformation can catch them for us
	BHTs = [
		fs.readFileSync(__dirname + "/MOUSE0.bht"),
		fs.readFileSync(__dirname + "/MOUSE1.bht"),
		fs.readFileSync(__dirname + "/MOUSE2.bht"),
		fs.readFileSync(__dirname + "/MOUSE3.bht"),
		fs.readFileSync(__dirname + "/MOUSE4.bht"),
		fs.readFileSync(__dirname + "/MOUSE5.bht"),
		fs.readFileSync(__dirname + "/MOUSE6.bht"),
		fs.readFileSync(__dirname + "/MOUSE7.bht"),
		fs.readFileSync(__dirname + "/MOUSE8.bht"),
		fs.readFileSync(__dirname + "/MOUSE9.bht"),
		fs.readFileSync(__dirname + "/MOUSE10.bht"),
		fs.readFileSync(__dirname + "/MOUSE11.bht"),
		fs.readFileSync(__dirname + "/MOUSE12.bht"),
		fs.readFileSync(__dirname + "/MOUSE13.bht"),
	],

	decoder = new AnimationDecoder(mouseBHD);
